  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-indigo-900 flex items-center justify-center font-comic text-white">
      <div className="bg-black/40 backdrop-blur-md p-8 rounded-xl shadow-lg w-full max-w-md">
        <h2 className="text-3xl font-bold text-green-300 mb-6 text-center">🧑‍🎓 Student Login</h2>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full px-4 py-2 bg-green-500 hover:bg-green-600 rounded text-white font-semibold transition"
          >
            Login
          </button>
        </form>
        <p className="mt-4 text-sm text-gray-300 text-center">
          Not registered?{" "}
          <button onClick={() => navigate('/register')} className="text-green-300 hover:underline">
            Create an account
          </button>
        </p>
      </div>
